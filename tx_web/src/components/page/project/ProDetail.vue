			...
			<el-tabs :tab-position="tabPosition" @tab-click="handleChange">
				<el-tab-pane label="项目登记">
					<el-tabs style="margin-left: 10%;width: 88%;" v-model="activeName" type="card" @tab-click="handleClick">
						...
						<!-- 实测标准页面 -->
						<el-tab-pane label="标准定义" name="fourth">
							<registerStandard></registerStandard>
							<!-- <chaneViolations></chaneViolations> -->
						</el-tab-pane>
					</el-tabs>
				</el-tab-pane>


				<el-tab-pane label="楼栋定义" style="margin-left: 10%;width: 88%;" >
...
<script>
	...
	// import chaneViolations from '../../dialog/system/ChaneViolations'
	export default {
		name: 'basetable',
		components: {
			registerBase,
