<template>
	<div>
		<el-row style="width: 80%;">
			<el-col :span="24">
				<div class="grid-content title-text title-box">标准定义</div>
			</el-col>
			<el-col :span="4" class="px-1">
				<div class="grid-content info-label title-box">实测实量标准：</div>
			</el-col>
			<el-col :span="18">
			...
			<el-col :span="4" class="px-1">
				<div class="grid-content info-label title-box">违章数据库</div>
			</el-col>
			<el-col :span="18">
				<!-- <div class="grid-content title-text title-box" style="width: 30%;">
					<el-input
