    ...
    routes: [
        ...
        },
        {
            ...
            children: [
				...
				{
				    path: '/measured',
					component: resolve =>require(['@/components/page/datacheck/MeasuredQuantity.vue'],resolve),
				    meta: { title: '实测实量' }
				},
				{
				    path: '/inspectDetail',
                ...
                //     meta: { title: '质量巡检标准', permission: true }
                // },
                {
                    path: '/database',
					component: resolve =>require(['@/components/page/system/Database.vue'],resolve),
				...
				//     path: '/FromExport',
				// 	name:'FromExport',
				// 	component: resolve =>require(['@/components/page/datacheck/FromExport.vue'],resolve),
				//     meta: { title: '表单导出'}
				// }
            ]
        },
