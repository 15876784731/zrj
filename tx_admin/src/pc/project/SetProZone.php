<?php
	...
	switch($flag){
		...
		case 'getSection':
			$proTimeStamp = isset($_POST["proTimeStamp"])?$_POST["proTimeStamp"]:'';
			$categroy = isset($_POST["category"])?$_POST["category"]:'';
			$build = isset($_POST["build"])?$_POST["build"]:'';
			$unitNum = isset($_POST["unitNum"])?$_POST["unitNum"]:'';
			$undergroundNumber = isset($_POST["undergroundNumber"])?$_POST["undergroundNumber"]:'';
			$abovegroundNumber = isset($_POST["abovegroundNumber"])?$_POST["abovegroundNumber"]:'';
