			...
			<view class="uni-list-cell">
				<view class="uni-list">
					<view class="uni-list-cell">
						...
						<view class="uni-list-cell-db">
							 <ld-select3 :multiple="true" :list="options1" list-key="label" value-key="value" placeholder="请选择检查工序" clearable v-model="formData.inspectProcedure"
			...
			<view class="uni-list-cell">
				<view class="uni-list">
					<view class="uni-list-cell">
						...
						<view class="uni-list-cell-db">
							<ld-select4 :multiple="true" :list="options2" list-key="label" value-key="value" placeholder="请选择检查内容" clearable v-model="formData.inspectContent"
				...
				<view class="uni-list-cell">
					<view class="uni-list">
						<view class="uni-list-cell">
							...
							<view class="uni-list-cell-db"><input class="uni-input" type="text" v-model="formData.inspectleader" /></view>
						</view>
					</view>
				</view>
				<view class="uni-list-cell">
					<view class="uni-list">
						<view class="uni-list-cell">
							...
							<view class="uni-list-cell-db"><input class="uni-input" type="text" v-model="formData.inspectnumber" /></view>
						</view>
					</view>
				</view>
				<view class="uni-list-cell">
					<view class="uni-list">
						<view class="uni-list-cell">
							<view class="uni-list-cell-left">添加备注：</view>
							<view class="uni-list-cell-db"><input class="uni-input muchmore" type="text" v-model="formData.inspectremark" /></view>
						</view>
					</view>
				</view>
		</view>
		<pick-date class="mt-1" datename="检查日期：" @date="getInspectDate"></pick-date>
		<pick-date class="mt-1" datename="施工日期：" @date="getEndDate"></pick-date>
