<template>
	<view>
		...
		<uni-list>
		    <uni-list-item to="PhotoAlbum">
		        <view slot="header" class="slot-box"><image class="slot-image" src="../../../../static/images/wbjc.png" mode="widthFix"></image></view>
		        <text slot="body" class="slot-box slot-text">工序检查</text>
		    </uni-list-item>
		</uni-list>
		
		<uni-list>
		    <uni-list-item to="FileInspect">
		        <view slot="header" class="slot-box"><image class="slot-image" src="../../../../static/images/wbjc.png" mode="widthFix"></image></view>
		        <text slot="body" class="slot-box slot-text">工序验收</text>
		    </uni-list-item>
		</uni-list>	
