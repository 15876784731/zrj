<template>
	<view class="page">
		...
		<navigator class="buttons" url="../../../components/uni-inspect/uni-inspect-album/takephoto?dotype=face"><button type="primary">打开自定义相机</button></navigator>
		...
		<view v-for="(item,index) in imagesrc" :key="index">
			<image  class="preview" :src="item" mode="aspectFit" style="width:710rpx:height:710rpx;margin: 20rpx;"></image>
		</view>
